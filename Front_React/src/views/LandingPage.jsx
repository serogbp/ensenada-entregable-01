			...
			<main className="flex-grow-1">
				...
				<div className="d-flex flex-column flex-xl-row">
					<div className="feature feature--col flex-grow-1 bg-tecla-pink">
						...
						<p className="max-w-prose landing-text">Nuestra comunidad es inclusiva y diversa, y nos enorgullece ofrecer un ambiente seguro y respetuoso para todos nuestros miembros. Ya seas un desarrollador principiante o un experto en el campo, estamos seguros de que encontrarás valor en nuestra plataforma.</p>
					</div>
					<div className="feature feature--col flex-grow-1 bg-tecla-yellow">
						<h2 className="display-2 fw-bolder">¿Por qué //TECLA_SOCIAL?</h2>
						<p className="max-w-prose landing-text">Ofrecemos herramientas específicas para desarrolladores, así como un lugar seguro y acogedor para todos los niveles de experiencia. Además, es una excelente manera de mantenerse actualizado sobre las últimas tendencias y novedades en el mundo del desarrollo de software.</p>
					</div>
				</div>
				...
				<div className="feature feature--col">
					...
					<ul className="gap-4 d-flex flex-column landing-text">
